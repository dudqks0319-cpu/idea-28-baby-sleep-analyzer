...
import 'package:app_28_baby_sleep_analyzer/app.dart';
import 'package:app_28_baby_sleep_analyzer/services/supabase_service.dart';
...
void main() {
  testWidgets('회원가입 후 할 일을 추가하고 추천 목록에서 확인할 수 있다', (tester) async {
    ...
    expect(find.text('아기 수면 패턴 분석'), findsWidgets);
